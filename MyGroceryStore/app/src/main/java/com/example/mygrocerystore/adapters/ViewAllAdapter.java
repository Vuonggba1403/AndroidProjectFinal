...
public class ViewAllAdapter extends RecyclerView.Adapter<ViewAllAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.price.setText("Price: " +list.get(position).getPrice()+ " VNĐ/kg");

        if(list.get(position).getType().equals("egg")) {
            holder.price.setText("Price: " +list.get(position).getPrice()+" VNĐ/dozen");
        } else if (list.get(position).getType().equals("milk")) {
            holder.price.setText("Price: " + list.get(position).getPrice() + " VNĐ/box");
        }
